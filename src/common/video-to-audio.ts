export default function convert(videoFileData: File | Blob, targetAudioFormat: string): Promise<Blob> {
    return new Promise((resolve, reject) => {
        ...
        reader.onload = function (event) {
            ...
            if (!videoFileAsBuffer || typeof videoFileAsBuffer === "string") return reject();
