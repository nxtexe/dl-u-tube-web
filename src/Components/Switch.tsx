...
export const Switch = styled((props) => (
    ...
    '& .MuiSwitch-switchBase': {
      ...
      '&.Mui-checked': {
        ...
        color: '#fff',
        '& + .MuiSwitch-track': {
          backgroundColor: theme.palette.mode === 'dark' ? theme.palette.primary.light : '#65C466',
          opacity: 1,
          border: 0,
        },
    ...
    '& .MuiSwitch-track': {
      borderRadius: 26 / 2,
      backgroundColor: theme.palette.mode === 'light' ? '#E9E9EA' : theme.palette.secondary.main,
      opacity: 1,
